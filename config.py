...
class Config(object):
    ...
    ALIVE_NAME = os.environ.get("ALIVE_NAME", MookhyangBOT)
    # Get the values for following 2 from my.telegram.org
    APP_ID = int(os.environ.get("APP_ID", 18502359))
    API_HASH = os.environ.get("API_HASH", 34e88194ac25a465e94ae31e98aa0978) 34e88194ac25a465e94ae31e98aa0978
    ...
    STRING_SESSION = os.environ.get("STRING_SESSION", 1BVtsOLUBu4KiUDJwwEXpLfcnOrPw-IEe8TaJ5CMIStyMyxGMRH9kkss1DlCmGUbsqqB9k28tLhZb6KtDv7l7h_plX516-KrLtwBwsxOOCoImFsKg1xEMaDk-XltZtMG8OGrXqXhiTMHLAR_rTkXczWjj31TgL2LDZAi-zyoiLMkKSUa9wh_SO2spK8bKFTQU4YwK7mMatsaSCIEO0h0ygb13MEk2xt1pdxLAjJ6NFxJS0J7oukmU3v9js27VojJNTJV4veQWI-i3yRPblbUTyzQCZa9vZdePWZqHTj2Kzid9sG1uoniWhsnFohPFyXqCBlo31r3kx61WfBPUlCL41w2qKWoQmZQ=)
    # Telegram BOT Token and bot username from @BotFather
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN") or os.environ.get(
        "TG_BOT_TOKEN_BF_HER", 6410169927:AAHmACnpyZ2wLc5a91G5H_jlVmTf-eeGYQE
    )
    ...
    PRIVATE_GROUP_ID = int(os.environ.get("PRIVATE_GROUP_ID") or -1002082931080)
